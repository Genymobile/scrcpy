...
build-win32: prepare-deps
	...
	cp -r app/prebuilt-deps/data/SDL2-2.30.0/i686-w64-mingw32/. "$(WIN32_BUILD_DIR)/local/"
...
build-win64: prepare-deps
	...
	cp -r app/prebuilt-deps/data/SDL2-2.30.0/x86_64-w64-mingw32/. "$(WIN64_BUILD_DIR)/local/"
