...
dist-win64: build-server build-win64
	...
	cp prebuilt-deps/ffmpeg-4.4-full_build-shared/bin/swresample-3.dll "$(DIST)/$(WIN64_TARGET_DIR)/"
	cp prebuilt-deps/ffmpeg-4.4-full_build-shared/bin/swscale-5.dll "$(DIST)/$(WIN64_TARGET_DIR)/"
