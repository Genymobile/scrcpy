...
Since Android 11, a [wireless debugging option][adb-wireless] allows you to bypass
having to physically connect your device to your computer.
...
A small tool (by the scrcpy author) allows you to run arbitrary commands whenever a
