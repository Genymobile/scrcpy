...
La [finestra può anche essere ruotata](#rotation) indipendentemente.
...
Notare che _scrcpy_ gestisce 3 diversi tipi di rotazione:
 ...
 - [`--lock-video-orientation`](#lock-video-orientation) cambia l'orientamento della trasmissione (l'orientamento del video inviato dal dispositivo al computer). Questo influenza la registrazione.
