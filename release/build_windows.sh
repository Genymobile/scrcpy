...
cp "$WINXX_BUILD_DIR"/app/scrcpy-auto.exe "$WINXX_BUILD_DIR/dist/"
cp app/data/scrcpy-auto-noconsole.vbs "$WINXX_BUILD_DIR/dist/"
cp app/data/scrcpy-auto.png "$WINXX_BUILD_DIR/dist/"
cp app/data/scrcpy-auto-disconnected.png "$WINXX_BUILD_DIR/dist/"
